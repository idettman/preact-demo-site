...
var Bash = (function (Component$$1) {
	function Bash () {
		Component$$1.apply(this, arguments);
	}

	if ( Component$$1 ) Bash.__proto__ = Component$$1;
	Bash.prototype = Object.create( Component$$1 && Component$$1.prototype );
	Bash.prototype.constructor = Bash;

	Bash.prototype.render = function render$$1 () {
		return (
			h( 'div', { className: "about" },
				h( 'h1', null, "Bash Reference" ),
				h( 'h2', null, "OSX Terminal" ),
				h( 'ul', null,
					h( 'li', null,
					...
					h( 'li', null,
						h( 'h3', null, "curl" ),
						h( 'code', null, "curl --proxy http://proxy.com:80 http://target.com:80" ),
...
var Definitions = (function (Component$$1) {
	...
	Definitions.prototype.render = function render$$1 () {
		return (
			h( 'div', null,
				h( 'h1', null, "Definitions" ),
				h( 'ul', null,
					h( 'li', null,
						h( 'h2', null, "JavaScript" ),
						h( 'dl', null,
							h( 'dt', null, "closure" ),
					...
					h( 'li', null,
						...
						h( 'ul', null,
							h( 'li', null, "menu" ),
							h( 'li', null, "sub-menu" ),
							h( 'li', null, "filtered-menu" ),
							h( 'li', null, "menu bar" ),
							h( 'li', null, "menu button" ),
							h( 'li', null, "menu item" ),
							h( 'li', null, "menu separator" ),
							h( 'li', null, "tree" ),
							h( 'li', null, "tab" ),
							h( 'li', null, "tab bar" ),
							h( 'li', null, "table" ),
							h( 'li', null, "table sorter" ),
							h( 'li', null, "tool-tip" ),
							h( 'li', null, "tool-bar" ),
							h( 'li', null, "drag-drop detector" ),
							h( 'li', null, "date picker" ),
							h( 'li', null, "combo-box" ),
							h( 'li', null, "checkbox" ),
							h( 'li', null, "input" ),
							h( 'li', null, "grid" ),
							h( 'li', null, "auto-complete" ),
							h( 'li', null, "bubble" ),
							h( 'li', null, "button" ),
							h( 'li', null, "dialog" ),
							h( 'li', null, "card" ),
							h( 'li', null, "hover-card" )
						)
					)
				)
	...
	h( 'main', null,
		...
		h( 'div', { className: "page-content" },
			h( Router, null,
				...
				h( Definitions, { path: getNavPath('definitions') }),
				h( Bash, { path: getNavPath('bash') }),
				h( Repos, { path: getNavPath('repos') }),
				h( GitFlow, { path: getNavPath('gitflow') })
			)
		)
	)
), document.body);
